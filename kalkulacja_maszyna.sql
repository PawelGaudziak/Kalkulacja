...
--
-- Table structure for table `maszyna`
--
...
CREATE TABLE `maszyna` (
  ...
  `maszyna` varchar(45) COLLATE utf8_polish_ci NOT NULL,
  PRIMARY KEY (`id_m`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `maszyna`
--

LOCK TABLES `maszyna` WRITE;
/*!40000 ALTER TABLE `maszyna` DISABLE KEYS */;
INSERT INTO `maszyna` VALUES (1,'B1'),(2,'B2');
